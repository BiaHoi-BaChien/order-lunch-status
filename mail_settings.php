...
$envPath = __DIR__ . '/.env';
$settings = [
    'MAIL_MATSUYA_ORDER_FROM' => ['label' => '松屋: 注文確認メールの送信元', 'type' => 'text'],
    'MAIL_MATSUYA_ORDER_SUBJECT' => ['label' => '松屋: 注文確認メールの件名', 'type' => 'text'],
    'MAIL_MATSUYA_RECEIPT_FROM' => ['label' => '松屋: 受付確認メールの送信元（|区切りで複数指定可）', 'type' => 'text'],
    'MAIL_MATSUYA_RECEIPT_SUBJECT' => ['label' => '松屋: 受付確認メールの件名', 'type' => 'text'],
    'MAIL_RAMEN_KIMURA_ORDER_FROM' => ['label' => 'RAMEN KIMURA: 注文確認メールの送信元', 'type' => 'text'],
    'MAIL_RAMEN_KIMURA_ORDER_SUBJECT' => ['label' => 'RAMEN KIMURA: 注文確認メールの件名', 'type' => 'text'],
    'MAIL_MATSUYA_FIELD_DATE_LABELS' => ['label' => '松屋: 日付欄の質問文', 'type' => 'list'],
    'MAIL_MATSUYA_FIELD_TICKET_LABELS' => ['label' => '松屋: お弁当番号欄の質問文', 'type' => 'list'],
    'MAIL_MATSUYA_FIELD_ITEM_LABELS' => ['label' => '松屋: 品名欄の質問文', 'type' => 'list'],
    'MAIL_MATSUYA_FIELD_SIZE_LABELS' => ['label' => '松屋: サイズ欄の質問文', 'type' => 'list'],
    'MAIL_MATSUYA_FIELD_NOTE_LABELS' => ['label' => '松屋: 備考欄の質問文', 'type' => 'list'],
    'MAIL_MATSUYA_FIELD_NOTE_APPEND_LABELS' => ['label' => '松屋: 備考へ追記する質問文', 'type' => 'list'],
    'MAIL_MATSUYA_KNOWN_ITEMS' => ['label' => '松屋: 認識する品名候補', 'type' => 'list'],
];
